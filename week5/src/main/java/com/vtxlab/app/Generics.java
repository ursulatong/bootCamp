...
public class Generics {
  ...
  public static void main(String[] args) {
    ...
    System.out.print(Customer.calcAge(Integer.valueOf(4)));
    // System.out.println(Customer.calcAge(String.valueOf("String")));
    // return error as the return type cannot be String
