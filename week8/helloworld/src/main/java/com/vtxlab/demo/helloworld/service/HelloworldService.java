...
//@Service // business logic (e.g +,-,x, concat)
@Component // (include )
public class HelloworldService {
  ...
  public String sayHelloworldService(String string) {
  ...
  public String updateFirst(String element) {
    // update first element if it exist

    if (strings.isEmpty()) {
      strings.add(element);
      return element;
    }
    // add first element if it does not receive
