...
@Slf4j
@Component // 要自己係BEAN先可以AUTOWIRED人地
public class WeatherApi {
  ...
  String serviceVers, String serviceUrl, HashMap<String, String> queryParms, 
  ...
  public <T extends WeatherResponseinterface> T invoke(String baseUrl, String serviceVers, String serviceUrl,
      HashMap<String, String> queryParms, Class<T> returnType) throws ApiException {
       try {
